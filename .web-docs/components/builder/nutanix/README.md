...
- `ova_create` (bool) - Create OVA image for the vm (default is false).
- `ova_export` (bool) - Export OVA image in the current folder (default is false).
- `ova_format` (string) - Format of the ova image (allowed values: 'vmdk', 'qcow2', default 'vmdk').
- `ova_name` (string) - Name of the the OVA image (default is false).
