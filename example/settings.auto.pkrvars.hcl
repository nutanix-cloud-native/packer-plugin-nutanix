...
centos_disk_image_name =  "<name of a centos 7/8 cloud image from the Nutanix image library>"
ubuntu_iso_image_name = "<name of a Ubuntu iso from the Nutanix image library>"
ubuntu_disk_image_name = "<name of a Ubuntu cloud image from the Nutanix image library>"
